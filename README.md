...
This repository includes data and Python code used to predict the surface age of S-type and V-type asteroid families.

**Training Data**
You can find the training data here "https://github.com/Lakshika1990/Asteroid_surface_age_prediction/tree/main/Ensemble_model/reflectance_spectra_training%26validation" This folder has raw data of the olivine, pyroxene, olivine-pyroxene mixtures, and OCs reflectance spectra. The first row gives the name of the sample. The first column, 'W' is wavelength in um, and the second column is reflectance.

Python_scripts: This folder contains Python scripts for MOdel_training_and_validation.ipynb - model training and saving. Load_model_and_prediction.ipynb - Determine the SW age for asteroids, and Distance_correction.ipynb -  distance correction for SW age.
